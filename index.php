...
<!DOCTYPE html>
  <head>
    ...
    <title>Happy New Year <?=$nam_show?></title>    
  ...
  <script>
var canvas=document.getElementById("canvastext"),ctx=canvas.getContext("2d"),W=window.innerWidth,H=window.innerHeight,text="<?=$nam_show?>",text2="Chúc Mừng Năm Mới",skipCount=4,gravity=.2,touched=!1,mouse={},minDist=20,bounceFactor=.6;canvas.height=H;canvas.width=W;function trackPos(a){mouse.x=a.pageX;mouse.y=a.pageY}
